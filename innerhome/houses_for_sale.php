...
<html>
<head>
    <title>Real Estate Website - Houses for Sale</title>
...
<body>
    ...
    <?php include 'header.php'; ?>
        ...
        <div class="properties-listing spacer">
            ...
            $properties = getHousesForSale($con);
            ...
            foreach ($properties as $property) {
                ...
                echo '</div>';
                echo '<h4 class="mb-0 text-center">' . $property['property_title'] . '</h4>';
                echo '<p style="font-weight: 900" class="text-center p-1">Address: ' . htmlspecialchars($property['property_address']) . '</p>';
                echo '<p class="text-center p-2">Price: KSH ' . $property['price'] . '</p>';
